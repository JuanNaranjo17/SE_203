...
// Define an array with pointers to functions, these functions don't return nothing and don't have arguments.
// The pointers are constants (The address pointed is constant)
// Save the vector_table in the section named .isr_vector defined in the linker script

void (* const vector_table[])(void) __attribute__((section(".isr_vector"))) = {
    // Stack and Reset Handler
    (void*)&_stack_start,              /* Top of stack  (initial value of the SP register) */
    ...
    BusFault_Handler,                  /* Memory access fault */
    UsageFault_Handler,                /* Undefined action or illegal state*/
    0,                                 /* Reserved */
    0,                                 /* Reserved */
    0,                                 /* Reserved */
    0,                                 /* Reserved */
...
// Set up VTOR to point to the interruption table header
void irq_init(void){
